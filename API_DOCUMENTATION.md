...
To integrate with the **Central Bank of Yemen Digital (CBOYD)**, all Payment Service Providers (PSPs) like Jeeb, OneCash, Cash, Jawaly, and others must use **OAuth 2.0** with a Central Private Key issued by Eng. Awsan Adel.
